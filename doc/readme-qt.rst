VCLASSICCOIN-qt: Qt4 GUI for VCLASSICCOIN
===============================
...
Alternatively, install Qt Creator and open the `VCLASSICCOIN-qt.pro` file.

An executable named `VCLASSICCOIN-qt` will be built.
...
A warning for people using the *static binary* version of VCLASSICCOIN on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of VCLASSICCOIN is linked against libdb5.3.
...
installed causes VCLASSICCOIN-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
