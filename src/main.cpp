...
const string strMessageMagic = "VCLASSICCOIN Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("VCLASSICCOIN-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in VCLASSICCOIN
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // VCLASSICCOIN: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VCLASSICCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1507731743;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2660596; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        //assert(block.hashMerkleRoot == uint256("0x4cb33b2b6a861dcbc685d3e614a9cafb945738d6833f182855679f2fad02057b"));
