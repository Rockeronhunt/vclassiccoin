...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("vcc");
    case mBTC: return QString("mvcc");
    case uBTC: return QString::fromUtf8("μvcc");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("VCLASSICCOINs"));
    case mBTC: return QString(QObject::tr("Milli-VCLASSICCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-VCLASSICCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
